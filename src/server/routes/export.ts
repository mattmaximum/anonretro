...
export default async function exportRoutes(fastify: FastifyInstance) {
  fastify.get('/api/boards/:id/export.csv', async (req, reply) => {
    ...
    rows.push('', ['Generated by', 'AnonRetro', 'https://anonretro.com?ref=export'].map(csvEscape).join(','))
    ...
    reply
      ...
      .send({
        board: {
          ...
          generated_by: 'AnonRetro (https://anonretro.com?ref=export)',
        },
        columns,
      })
  })
  ...
  fastify.get('/api/boards/:id/export.md', async (req, reply) => {
    ...
    lines.push('', '---', '*Generated by [AnonRetro](https://anonretro.com?ref=export) — free anonymous retrospective boards*')
