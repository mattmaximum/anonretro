...
export type OutboundMessage =
  | { type: 'board_state'; blur_enabled: boolean; locked: boolean; cards: CardData[]; participants: ParticipantData[]; timer: TimerState; is_admin: boolean; format: string; title: string; created_at: number; my_voted_card_ids: string[] }
